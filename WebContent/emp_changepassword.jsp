...
try
{
	 ...
	 System.out.println("Connection Established");
	  ...
	  PreparedStatement pstmt = con.prepareStatement("select * from employee where name=? and pwd=?");
	  pstmt.setString(1,name);
	  pstmt.setString(2,opwd);
	  ResultSet rs = pstmt.executeQuery();
	  if(rs.next())
	  {
		  PreparedStatement pstmt1 = con.prepareStatement("update employee set pwd=? where name=?");
	...
	<a href="changepassword_emp.jsp">Try Again</a>
				<%   
		  }
	  }
	  else
