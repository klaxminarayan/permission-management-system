...
try
{
	 ...
	 System.out.println("Connection Established");
	  ...
	  PreparedStatement pstmt = con.prepareStatement("select * from manager where name=? and pwd=?");
	  pstmt.setString(1,name);
	  pstmt.setString(2,opwd);
	  ResultSet rs = pstmt.executeQuery();
	  if(rs.next())
	  {
		  PreparedStatement pstmt1 = con.prepareStatement("update manager set pwd=? where name=?");
	...
	<a href="changepassword_man.jsp">Try Again</a>
				<%   
		  }
	  }
	  else
