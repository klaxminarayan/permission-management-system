...
<h3 align="center">MANAGER HOME </h3>
<style>
ul {
...
<li class="dropdown">
    <a href="viewpermission1.jsp" class="dropbtn">View Permissions</a>
...
<form method="post" action="manupdaterequest.jsp">
      ...
      <table align="center" width="40%" height="20%">
          ...
          <tr>
              <td><b></b></td>
              <td><input type="text" name="managerstatus" required></td>
          </tr>
                     <tr>
