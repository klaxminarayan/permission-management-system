...
<table align=center  >
<tr align=center  bgcolor="#FF6666" border=20>
<th>ID</th>
<th>NAME</th>
<th>EMAIL</th>
<th>CATEGORY</th>
...
System.out.println("Connection Established");
 ...
 PreparedStatement pstmt = con.prepareStatement("select * from permission where managerstatus='PROCESSING'");
 ...
 while(rs.next())
{
	...
	<td><%=rs.getString("managerstatus")%></td>
	<td><%=rs.getString("finalstatus")%></td>
	<td> 
	 <a href="manageracceptrequest.jsp?id=<%=rs.getString("id")%>"><button type="button" class="btn btn-success">ACCEPT</button></a>
	 <a href="managerrejectrequest.jsp?id=<%=rs.getString("id")%>"><button type="button" class="btn btn-danger">REJECT</button></a>
  <br>
<br>
	</td>
